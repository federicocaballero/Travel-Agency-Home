...
const TopNavar = () => {
    return(
        <>
        <div class="text-center bg-color-topnavbar p-1 text-light">
        <div class="row">
            {/* DIV IZQUIERDO */}
            ...
            <div className="col d-flex flex-column p-1 gap-2">
                ...
                <div className="w-75 d-flex flex-row gap-3">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill text-warning" viewBox="0 0 16 16">
